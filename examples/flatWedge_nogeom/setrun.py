...
#------------------------------
    ...
    probdata.add_param('max1d', 820,  ' max size each dir for grid patches ')
    probdata.add_param('nloops',    0,  '# this problem rotates the IC, not geom.')
    #probdata.add_param('xloops',    .1667,  '# starting x loc ')
    #probdata.add_param('xloops',    .39,  '# starting x loc ')
    #probdata.add_param('yloops',    .01001,  '# starting y loc')
    ...
    clawdata.upper[0] = 3.000001e+00          # xupper
    clawdata.lower[1] = 0.000000e+00          # ylower
    clawdata.upper[1] = 1.00000000000           # yupper

    # Number of grid cells:
    #clawdata.num_cells[0] = 1410      # mx
    clawdata.num_cells[0] = 200      # mx
    clawdata.num_cells[1] = 90        # my
    #clawdata.num_cells[1] = 54       # my
    #clawdata.num_cells[0] = 720      # mx
    #clawdata.num_cells[1] = 240      # my
    ...
    clawdata.restart_file = 'fort.chk00379'  # File to use for restart data
    ...
    if clawdata.output_style==1:
        ...
        clawdata.output_times =  [0.0023221027, 0.2]
    ...
    clawdata.dt_initial = 1.000000e-03
    ...
    if clawdata.checkpt_style == 1:
        ...
        clawdata.checkpt_times = [0.0023221027,0.2]
